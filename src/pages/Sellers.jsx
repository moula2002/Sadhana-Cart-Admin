...
const Sellers = () => {
  ...
  const renderDocStatus = (status) => {
    ...
    let color = "bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300";
  ...
  const renderStatusBadge = (status) => {
    ...
    if (s === 'active' || s === 'approved') {
      ...
      colorClass = 'bg-gray-600/30 text-gray-500 dark:text-gray-400 border border-gray-300 dark:border-gray-600';
    }
    ...
    <div className="p-4 lg:p-6 bg-gray-50 dark:bg-gray-900 h-full min-h-screen">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 space-y-4 lg:space-y-0">
        <div className="flex items-center space-x-3">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Sellers Management</h1>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            {searchTerm && (
              <button
                onClick={clearSearch}
                className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white"
              >
                <X className="h-4 w-4" />
              </button>
            )}
      ...
      {/* Sort Info */}
      <div className="mb-4 p-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg flex justify-between items-center">
        <p className="text-gray-700 dark:text-gray-300 text-sm">
          Sorted by: <span className="font-semibold text-gray-900 dark:text-white">
      ...
      {/* --- Desktop Table View --- */}
      <div className="hidden md:block bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-xl">
          ...
          <table className="min-w-full divide-y divide-gray-700">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th 
                  className="px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:bg-gray-600 transition-colors"
                  onClick={handleSort}
                >
              ...
              {filteredSellers.length === 0 ? (
                <tr>
                  <td colSpan="5" className="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                    ...
                    <p className="text-lg font-medium text-gray-700 dark:text-gray-300">No sellers found</p>
                ...
                filteredSellers.map((seller) => (
                  <tr key={seller.id} className="hover:bg-gray-100 dark:bg-gray-700 transition-colors group">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex items-center space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button 
                          className="p-2 bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white rounded-lg transition-colors shadow-lg"
                        ...
                        <button 
                          className="p-2 bg-green-600 hover:bg-green-700 text-gray-900 dark:text-white rounded-lg transition-colors shadow-lg"
                        ...
                        <button 
                          className="p-2 bg-red-600 hover:bg-red-700 text-gray-900 dark:text-white rounded-lg transition-colors shadow-lg"
      ...
      <div className="md:hidden space-y-4">
        {filteredSellers.length === 0 ? (
          ...
          filteredSellers.map((seller) => (
            <div key={seller.id} className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 shadow-lg">
              <div className="flex items-center mb-4">
                <div className="h-12 w-12 rounded-full bg-blue-500 flex items-center justify-center">
                  <span className="text-gray-900 dark:text-white font-medium text-lg">{getSellerInitials(seller)}</span>
                </div>
                <div className="ml-4 flex-1">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">{getSellerName(seller)}</h3>
                  {seller.businessName && <div className="text-sm text-blue-300">{seller.businessName}</div>}
                  <p className="text-sm text-gray-500 dark:text-gray-400">ID: {seller.id.substring(0, 20)}...</p>
                </div>
                <div className="ml-2">
                  {renderStatusBadge(seller.status)}
                </div>
              ...
              <div className="space-y-2 mb-4 border-t border-b border-gray-200 dark:border-gray-700 py-3">
                {seller.email && (<div className="flex items-center text-sm text-gray-700 dark:text-gray-300"><Mail className="h-4 w-4 mr-2 text-blue-400" /><span className="break-all">{seller.email}</span></div>)}
                {seller.phone && (<div className="flex items-center text-sm text-gray-700 dark:text-gray-300"><Phone className="h-4 w-4 mr-2 text-green-400" /><span>{seller.phone}</span></div>)}
                <div className="flex items-center text-sm text-gray-700 dark:text-gray-300"><Calendar className="h-4 w-4 mr-2 text-purple-400" /><span>
                  {seller.registrationDate 
                    ? new Date(seller.registrationDate).toLocaleDateString()
                    : seller.createdAt 
                    ? (seller.createdAt.toDate 
              ...
              <div className="flex space-x-2">
                <button 
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors shadow-md flex items-center justify-center gap-2"
                  onClick={() => handleViewSeller(seller)}
                >
                  <User size={16} />
                  View
                ...
                <button 
                  className="flex-1 bg-green-600 hover:bg-green-700 text-gray-900 dark:text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors shadow-md flex items-center justify-center gap-2"
                  onClick={() => handleMessageSeller(seller)}
                >
                  <MessageSquare size={16} />
                  Message
                ...
                <button 
                  className="flex-1 bg-red-600 hover:bg-red-700 text-gray-900 dark:text-white py-2 px-3 rounded-lg text-sm font-medium transition-colors shadow-md flex items-center justify-center gap-2"
                  onClick={() => handleBlockSeller(seller.id)}
                >
                  <Shield size={16} />
                  Block
      ...
      {showModal && selectedSeller && (
        <div className="fixed inset-0 bg-black bg-opacity-85 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-gray-50 dark:bg-gray-900 rounded-xl max-w-6xl w-full max-h-[95vh] overflow-y-auto shadow-2xl border border-gray-200 dark:border-gray-700">
            {/* Modal Header */}
            <div className="sticky top-0 bg-gray-50 dark:bg-gray-900 flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700 z-10">
              <div className='flex items-center space-x-3'>
                <ShieldCheck className='h-7 w-7 text-blue-500'/>
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Seller Profile & Verification</h2>
              </div>
              <button 
                onClick={closeModal}
                className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white p-2 rounded-full hover:bg-gray-100 dark:bg-gray-700 transition-colors"
              >
                <X className="h-6 w-6" />
              </button>
            </div>
            ...
            <div className="p-6 space-y-8">
              ...
              {/* Profile Card & Status */}
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-inner flex flex-col md:flex-row justify-between items-start md:items-center border border-gray-200 dark:border-gray-700/50">
                <div className="flex items-center space-x-4 mb-4 md:mb-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white">{getSellerName(selectedSeller)}</h3>
                    {selectedSeller.businessName && (
                      <p className="text-md font-medium text-blue-300">{selectedSeller.businessName}</p>
                    )}
                    <p className="text-sm text-gray-500 dark:text-gray-400 font-mono mt-1">ID: {selectedSeller.id}</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {/* Contact */}
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700/50 space-y-3">
                  ...
                  <div className='space-y-2'>
                    ...
                    <p className="text-gray-900 dark:text-white font-medium break-all">{selectedSeller.email || 'N/A'}</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-200 dark:border-gray-700">Phone:</p>
                    <p className="text-gray-900 dark:text-white font-medium">{selectedSeller.phone || 'N/A'}</p>
                  </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700/50 space-y-3">
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-2">Address:</p>
                  <p className="text-gray-900 dark:text-white text-sm">{selectedSeller.address || 'N/A'}</p>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700/50 space-y-3">
                  ...
                  <p className="text-gray-900 dark:text-white font-medium break-all">{selectedSeller.gstNumber || 'N/A'}</p>
                  <p className="text-sm text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-200 dark:border-gray-700">PAN Number:</p>
                  <p className="text-gray-900 dark:text-white font-medium">{selectedSeller.panNumber || 'N/A'}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700/50">
                  <table className="min-w-full divide-y divide-gray-700">
                    <thead className="bg-gray-100/80 dark:bg-gray-700/50">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">File Action</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-800">
                      {getSellerDocuments(selectedSeller).length > 0 ? (
                        getSellerDocuments(selectedSeller).map((doc) => (
                          <tr key={doc.fileUrl} className="hover:bg-gray-100 dark:bg-gray-700 transition-colors">
                            <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">{doc.category}</td>
              ...
              <div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700/50 min-h-[150px]">
                    ...
                    {sellerProducts.length > 0 && (
                      <div className="relative mb-4">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-10 py-2 bg-gray-700/70 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-pink-500 focus:border-pink-500 text-sm"
                        />
                        {productSearchTerm && (
                          <button
                    ...
                    {loadingProducts ? (
                        ...
                        <div className='overflow-hidden'>
                            ...
                            <div className="grid grid-cols-12 text-xs font-semibold uppercase text-gray-500 dark:text-gray-400 pb-2 border-b border-gray-200 dark:border-gray-700">
                            ...
                            <div className="space-y-2 max-h-64 overflow-y-auto pr-2 pt-2">
                                {filteredSellerProducts.length === 0 ? (
                                    <p className="text-gray-500 dark:text-gray-400 text-center pt-4">No products match your search.</p>
                                ) : (
                                    filteredSellerProducts.map((product) => ( 
                                        <div key={product.id} className="grid grid-cols-12 items-center bg-gray-100/80 dark:bg-gray-700/50 p-3 rounded-md hover:bg-gray-100 dark:bg-gray-700 transition-colors">
                                            <p className="col-span-6 text-gray-900 dark:text-white font-medium truncate text-sm">{product.name || 'Untitled Product'}</p>
                                            <p className="col-span-3 text-gray-700 dark:text-gray-300 text-sm">{product.category || 'N/A'}</p>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 text-center pt-8">This seller has no products listed yet.</p>
                    )}
                </div>
              </div>
              ...
              <div className="flex space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                <button 
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-gray-900 dark:text-white py-3 px-4 rounded-lg font-bold transition-transform transform hover:scale-[1.01] shadow-lg flex items-center justify-center gap-2"
                ...
                <button 
                  className="flex-1 bg-green-600 hover:bg-green-700 text-gray-900 dark:text-white py-3 px-4 rounded-lg font-bold transition-transform transform hover:scale-[1.01] shadow-lg flex items-center justify-center gap-2"
                  onClick={() => {
                ...
                <button 
                  className="flex-1 bg-red-600 hover:bg-red-700 text-gray-900 dark:text-white py-3 px-4 rounded-lg font-bold transition-transform transform hover:scale-[1.01] shadow-lg flex items-center justify-center gap-2"
                  onClick={() => {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl max-w-md w-full border border-gray-200 dark:border-gray-700 shadow-2xl">
            <div className="flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white">Send Message to Seller</h2>
              <button
                onClick={closeMessageModal}
                className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white transition-colors p-2 hover:bg-gray-100 dark:bg-gray-700 rounded-xl"
              >
                <X className="h-5 w-5" />
              </button>
            </div>
            <div className="p-6">
              <div className="mb-6 bg-gray-100/80 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-300 dark:border-gray-600">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Seller</label>
                <p className="text-gray-900 dark:text-white font-semibold">{getSellerName(selectedSeller)}</p>
                {selectedSeller.businessName && (
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Message Content</label>
                <textarea
                  value={messageText}
                  onChange={(e) => setMessageText(e.target.value)}
                  className="w-full bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white p-4 rounded-xl border border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20 resize-none"
                  rows="4"
              ...
              <div className="mb-6">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Send Via</label>
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 p-3 rounded-xl font-semibold transition-all duration-200 ${
                      selectedSeller.phone 
                        ? 'bg-green-600 hover:bg-green-700 text-gray-900 dark:text-white shadow-lg hover:shadow-xl' 
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 p-3 rounded-xl font-semibold transition-all duration-200 ${
                      selectedSeller.email 
                        ? 'bg-red-600 hover:bg-red-700 text-gray-900 dark:text-white shadow-lg hover:shadow-xl' 
                        : 'bg-gray-100 dark:bg-gray-600 text-gray-500 dark:text-gray-400 cursor-not-allowed'
                    }`}
                  >
                    <Mail size={18} />
              ...
              <div className="flex justify-end space-x-3">
                <button
                  onClick={closeMessageModal}
                  className="bg-gray-100 dark:bg-gray-600 hover:bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white px-6 py-3 rounded-xl transition-colors font-semibold"
                >
                  Cancel
                </button>
              </div>
              ...
              {!sending ? (
                <>
                  <div className="mb-6">
                    ...
                    <div className="bg-gray-100/80 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-300 dark:border-gray-600">
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Message Preview</label>
                      <p className="text-gray-900 dark:text-white text-sm whitespace-pre-wrap">{messageText}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-end space-x-3">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-gray-900 dark:text-white px-6 py-3 rounded-xl transition-all duration-200 font-semibold shadow-lg flex items-center gap-2"
                      disabled={sending}
                    >
                      <Send size={18} />
                      Send Message
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-900 dark:text-white font-semibold">Message sent successfully!</p>
                  <p className="text-gray-500 dark:text-gray-400 text-sm mt-2">Redirecting you back...</p>
                </div>
              )}
            </div>
          </div>
